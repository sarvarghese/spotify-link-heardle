                                        ...
                                        isPlaying === true ?
                                            (
                                                <div className="flex justify-center items-center text-custom-fg h-14 w-14 border-2 rounded-full relative overflow-hidden">
                                                    <button className="player-button" type="button" aria-label="stop song" title="stop song"
                                            ...
                                            (
                                                <div className="flex justify-center items-center text-custom-fg h-14 w-14 border-2 rounded-full relative overflow-hidden">
                                                    <button className="player-button" type="button" aria-label="start song" title="start song"
